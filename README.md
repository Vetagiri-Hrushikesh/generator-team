...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/A0bLAfVEx7)
...
```sh
npx nx serve generator-team
```

To create a production bundle:

```sh
npx nx build generator-team
```

To see all available targets to run for a project, run:

```sh
npx nx show project generator-team
```
